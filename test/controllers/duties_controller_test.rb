...
class DutiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create duty" do
    assert_difference('Duty.count') do
      post duties_url, params: { duty: { customer_id: @duty.customer_id, date: @duty.date, duration: @duty.duration, employee_id: @duty.employee_id } }
    end
  ...
  test "should update duty" do
    patch duty_url(@duty), params: { duty: { customer_id: @duty.customer_id, date: @duty.date, duration: @duty.duration, employee_id: @duty.employee_id } }
